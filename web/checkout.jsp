                                        ...
                                        <tbody>
                                            ...
                                            <% 
                                                ...
                                                for (ShoppingCart p: products){
                                                   ...
                                                   total=total+t.getPrice()*p.getQuantity();
                                            %>
                                            
                                                <tr class="cart_item">
                                                    <td class="product-name">
                                                        <%=t.getName()%> <strong class="product-quantity">X<%=p.getQuantity()%></strong> </td>
                                                    <td class="product-total">
                                                        <span class="amount subTotal">$<%=t.getPrice()*p.getQuantity()%></span> </td>
                                                </tr>
